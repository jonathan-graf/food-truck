      ...
      <div className="position-sticky pt-3 sidebar-sticky">
        <ul className="nav flex-column">
          <li className="nav-item">
            <a className="nav-link active" aria-current="page" href="#" onClick={() => setAction(Action.DASHBOARD)}>
          ...
          <li className="nav-item">
            <a className="nav-link" href="#" onClick={() => setAction(Action.PENDING)}>
        ...
        <ul className="nav flex-column mb-2">
          <li className="nav-item">
            <a className="nav-link" target="_blank" href="https://github.com/jonathan-graf/food-truck#readme" rel="noopener noreferrer">
